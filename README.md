...
| `application.appBar.disabled` | Whether the app bar should be disabled (not displayed) |
| `application.appBar.onTitleClick` | Action to run when the user clicks on the title from the app bar |
